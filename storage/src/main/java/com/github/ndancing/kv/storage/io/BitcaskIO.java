...
public final class BitcaskIO implements FileLogIO {
	...
	@Override
	public FileLogWriteResult write(BitcaskFileLog data) throws IOException {
	...
	@Override
	public FileLogWriteResult writeTo(BitcaskFileLog data, File file, FileChannel channel) throws IOException {
